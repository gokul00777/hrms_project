...
def employee_apply_leave(request):
    try:
        ...
        if not emp_leaves.year_updated:
            ...
            print(emp_leaves.EarnLeave ,"emp_leaves.EarnLeave ")
            print(emp_leaves.CasualLeave,"emp_leaves.CasualLeave")
